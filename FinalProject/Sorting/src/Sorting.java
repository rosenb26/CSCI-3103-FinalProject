...
public class Sorting {
    ...
    /**
     * A method to demonstrate and test the various sorts. Constructs seven
     * ArrayLists, each of size 15 and initially containing random integers in
     * the range [0, 999]. Each list is printed both before and after sorting.
     */
